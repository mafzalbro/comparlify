...
CREATE TABLE `Post` (
    ...
    `authorCredentials` VARCHAR(191) NULL,
    `keyTakeaways` JSON NULL,
    `checklist` JSON NULL,
    `categoryId` VARCHAR(191) NULL,
...
CREATE TABLE `PostFact` (
    ...
    INDEX `PostFact_postId_idx`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PostFaq` (
    ...
    INDEX `PostFaq_postId_idx`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PostSource` (
    ...
    INDEX `PostSource_postId_idx`(`postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
