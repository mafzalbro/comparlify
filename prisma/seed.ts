...
//         'Assessments & Quizzes': { hasFeature: true, details: 'Basic quiz functionality.' },
...
//       features: {
//         'Integrated Video Hosting': { hasFeature: true },
//         'Assessments & Quizzes': { hasFeature: true, details: 'Advanced options like question banks.' },
//         'Drip Content': { hasFeature: true },
//         'Community Forum': { hasFeature: true },
//         'Affiliate Marketing Tools': { hasFeature: true },
//         'Custom Certificate': { hasFeature: true },
//         'Mobile App Access': { hasFeature: false, details: 'Via 3rd party apps.' },
...
//         'Drip Content': { hasFeature: true },
//         'Community Forum': { hasFeature: true, details: 'Built-in community product.' },
//         'Affiliate Marketing Tools': { hasFeature: true },
//         'Custom Certificate': { hasFeature: true },
...
//         description: 'A creator-friendly platform for courses, digital downloads, and memberships with a focus on simplicity.',
//         logoUrl: '/logos/podia.svg',
//         features: {
//             'Integrated Video Hosting': { hasFeature: true },
//             'Assessments & Quizzes': { hasFeature: true, details: 'Simple multiple-choice quizzes.' },
//             'Drip Content': { hasFeature: true },
//             'Community Forum': { hasFeature: true },
//             'Affiliate Marketing Tools': { hasFeature: true },
...
//     for (const [featureName, featureDetails] of Object.entries(platformData.features)) {
