...
async function main(skipCleanup = false) {
  ...
  const toolsData: Omit<Prisma.ToolCreateInput, 'id' | 'createdAt' | 'updatedAt'>[] = [
    { slug: 'title-generator', title: 'AI Title Generator', description: 'Craft catchy, SEO-friendly titles for your course.', Icon: 'Lightbulb', category: 'Marketing', enabled: true, inputTopicLabel: 'Course Description', inputContextLabel: '', prompt: 'You are an expert in creating engaging and effective course titles. Based on the provided course description, generate a title that will attract more students and increase enrollment.\n\nCourse Description: {{{topic}}}' },
    { slug: 'course-outliner', title: 'AI Course Outliner', description: 'Generate a comprehensive, structured outline for your course.', Icon: 'FileText', category: 'CurriculumDesign', enabled: true, inputTopicLabel: 'Course Description', inputContextLabel: 'Existing Outline (optional)', prompt: 'You are an expert curriculum designer. Based on the provided course description, create a comprehensive and well-structured course outline. Use headings for modules and nested lists for lessons within each module. Each lesson should have a brief, one-sentence description.\n\nCourse Description: {{{topic}}}\n{{#if context}}\n\nExisting Outline:\n{{{context}}}\n\nContinue From There:{{/if}}' },
    { slug: 'video-scripter', title: 'AI Video Script Assistant', description: 'Create engaging scripts for your video lessons.', Icon: 'Video', category: 'ContentCreation', enabled: true, inputTopicLabel: 'Lesson Topic', inputContextLabel: 'Existing Script (optional)', prompt: 'You are an expert scriptwriter for educational videos. Based on the lesson topic, write a complete, word-for-word video script. Include cues for the presenter\'s tone (e.g., "[enthusiastically]") and suggestions for on-screen visuals (e.g., "[Show B-roll of...]").\n\nLesson Topic: {{{topic}}}\n{{#if context}}\n\nExisting Script:\n{{{context}}}\n\nContinue writing from here:{{/if}}' },
    { slug: 'lesson-summarizer', title: 'AI Lesson Summarizer', description: 'Automatically generate key takeaways for your lessons.', Icon: 'BookOpen', category: 'Productivity', enabled: true, inputTopicLabel: 'Lesson Content', inputContextLabel: 'Existing Summary (optional)', prompt: 'You are an expert at distilling information. Based on the lesson content, create a concise summary. It should be a short paragraph followed by the 3-5 most important key takeaways as a bulleted list.\n\nLesson Content: {{{topic}}}\n{{#if context}}\n\nExisting Summary:\n{{{context}}}\n\nContinue From There:{{/if}}' },
    { slug: 'blog-post-idea-generator', title: 'Blog Post Idea Generator', description: 'Generate a list of blog post ideas to attract your target audience.', Icon: 'FilePenLine', category: 'SEO', enabled: true, inputTopicLabel: 'Course Topic', inputContextLabel: 'Target Audience (optional)', prompt: 'You are a content marketing strategist. Generate a list of 5-7 blog post ideas that are relevant to the given course topic and target audience. The ideas should be engaging and designed to attract potential students.\n\nCourse Topic: {{{topic}}}\n{{#if context}}Target Audience: {{{context}}}{{/if}}' },
  ];
  ...
  const siteContent = [
    ...
    { key: 'theme.light.background', group: 'Theme', value: '0 0% 100%' },
    { key: 'theme.light.foreground', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.light.card', group: 'Theme', value: '0 0% 100%' },
    { key: 'theme.light.card-foreground', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.light.popover', group: 'Theme', value: '0 0% 100%' },
    { key: 'theme.light.popover-foreground', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.light.primary', group: 'Theme', value: '222.2 47.4% 11.2%' },
    { key: 'theme.light.primary-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.light.secondary', group: 'Theme', value: '210 40% 96.1%' },
    { key: 'theme.light.secondary-foreground', group: 'Theme', value: '222.2 47.4% 11.2%' },
    { key: 'theme.light.muted', group: 'Theme', value: '210 40% 96.1%' },
    { key: 'theme.light.muted-foreground', group: 'Theme', value: '215.4 16.3% 46.9%' },
    { key: 'theme.light.accent', group: 'Theme', value: '210 40% 96.1%' },
    { key: 'theme.light.accent-foreground', group: 'Theme', value: '222.2 47.4% 11.2%' },
    { key: 'theme.light.destructive', group: 'Theme', value: '0 84.2% 60.2%' },
    { key: 'theme.light.destructive-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.light.border', group: 'Theme', value: '214.3 31.8% 91.4%' },
    { key: 'theme.light.input', group: 'Theme', value: '214.3 31.8% 91.4%' },
    { key: 'theme.light.ring', group: 'Theme', value: '222.2 84% 4.9%' },

    // Theme Settings: Dark Mode
    { key: 'theme.dark.background', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.dark.foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.card', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.dark.card-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.popover', group: 'Theme', value: '222.2 84% 4.9%' },
    { key: 'theme.dark.popover-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.primary', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.primary-foreground', group: 'Theme', value: '222.2 47.4% 11.2%' },
    { key: 'theme.dark.secondary', group: 'Theme', value: '217.2 32.6% 17.5%' },
    { key: 'theme.dark.secondary-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.muted', group: 'Theme', value: '217.2 32.6% 17.5%' },
    { key: 'theme.dark.muted-foreground', group: 'Theme', value: '215 20.2% 65.1%' },
    { key: 'theme.dark.accent', group: 'Theme', value: '217.2 32.6% 17.5%' },
    { key: 'theme.dark.accent-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.destructive', group: 'Theme', value: '0 62.8% 30.6%' },
    { key: 'theme.dark.destructive-foreground', group: 'Theme', value: '210 40% 98%' },
    { key: 'theme.dark.border', group: 'Theme', value: '217.2 32.6% 17.5%' },
    { key: 'theme.dark.input', group: 'Theme', value: '217.2 32.6% 17.5%' },
    { key: 'theme.dark.ring', group: 'Theme', value: '212.7 93.5% 58.8%' },
