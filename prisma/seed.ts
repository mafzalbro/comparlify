...
async function main(skipCleanup = false) {
  ...
  const siteContent = [
    ...
    { key: 'theme.light.popover-foreground', group: 'Theme', value: '35 33% 20%' },
    { key: 'theme.light.primary', group: 'Theme', value: '45 93% 58%' },
    { key: 'theme.light.primary-foreground', group: 'Theme', value: '35 33% 15%' },
    { key: 'theme.light.secondary', group: 'Theme', value: '48 95% 91%' },
    { key: 'theme.light.secondary-foreground', group: 'Theme', value: '35 33% 20%' },
    { key: 'theme.light.muted', group: 'Theme', value: '48 95% 94%' },
    { key: 'theme.light.muted-foreground', group: 'Theme', value: '35 33% 45%' },
    { key: 'theme.light.accent', group: 'Theme', value: '45 93% 85%' },
    { key: 'theme.light.accent-foreground', group: 'Theme', value: '35 33% 15%' },
    { key: 'theme.light.destructive', group: 'Theme', value: '0 84.2% 60.2%' },
    { key: 'theme.light.destructive-foreground', group: 'Theme', value: '0 0% 98%' },
    ...
    { key: 'theme.dark.popover-foreground', group: 'Theme', value: '45 60% 95%' },
    { key: 'theme.dark.primary', group: 'Theme', value: '45 93% 58%' },
    { key: 'theme.dark.primary-foreground', group: 'Theme', value: '35 33% 15%' },
    { key: 'theme.dark.secondary', group: 'Theme', value: '30 10% 18%' },
    { key: 'theme.dark.secondary-foreground', group: 'Theme', value: '45 60% 95%' },
    ...
    { key: 'theme.dark.accent-foreground', group: 'Theme', value: '45 60% 95%' },
    { key: 'theme.dark.destructive', group: 'Theme', value: '0 62.8% 30.6%' },
    { key: 'theme.dark.destructive-foreground', group: 'Theme', value: '0 0% 98%' },
