...
const features = [
  {
    ...
    description:
      "Generate titles, outlines, scripts, and more with our powerful suite of AI assistants.",
  },
  {
    Icon: BarChart,
    title: "Compare Platforms",
    description:
      "Get unbiased, side-by-side comparisons of the top course creation platforms.",
  },
  {
    Icon: BookText,
    title: "Read the Blog",
    description:
      "Find expert tips and growth strategies to scale your online course business.",
  },
];

export function WelcomeOnboarding({ user }: WelcomeOnboardingProps) {
  const [isOpen, setIsOpen] = useState(user.onboarded);
    ...
    startTransition(async () => {
      try {
        ...
        toast({
          title: "Error",
          description:
            "Could not save onboarding status. You might see this again.",
          variant: "destructive",
        });
      }
    });
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-center pt-2">
            We're thrilled to have you here. Here's a quick look at what you can
            do.
          </DialogDescription>
        </DialogHeader>
