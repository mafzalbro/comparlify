...
export function FilterControls({
  ...
  return (
    <MotionDiv layout className="flex flex-wrap items-center gap-3 w-full">
      {/* --- Capsule Search --- */}
      <MotionDiv layout className="relative flex-1 min-w-[280px] group">
        ...
        {hasActiveFilters && (
          ...
          >
            <Button
              asChild
              variant="ghost"
              className="h-11 px-4 rounded-full text-[9px] font-black uppercase tracking-widest text-red-500 hover:text-red-500 hover:bg-red-500/5 transition-all"
            >
