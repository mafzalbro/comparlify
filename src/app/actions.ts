...
const lessonSummarySchema = z.object({
  lessonContent: z.string().min(20, { message: 'Content must be at least 20 characters long.' }).max(10000, { message: 'Content must be less than 10000 characters.'}),
});
...
export async function generateLessonSummaryAction(prevState: LessonSummaryState, formData: FormData): Promise<LessonSummaryState> {
...
const quizSchema = z.object({
  textContent: z.string().min(20, { message: 'Content must be at least 20 characters long.' }).max(10000, { message: 'Content must be less than 10000 characters.'}),
...
export async function generateQuizAction(prevState: QuizState, formData: FormData): Promise<QuizState> {
...
const personaSchema = z.object({
  courseIdea: z.string().min(10, { message: 'Idea must be at least 10 characters long.' }).max(2000),
});
...
export async function generateAudiencePersonaAction(prevState: PersonaState, formData: FormData): Promise<PersonaState> {
  ...
  try {
    ...
    console.error(error);
    return { persona: null, error: 'Failed to generate persona. Please try again.' };
  }
}

// --- Course Description Writer Action ---
const courseDescriptionSchema = z.object({
  courseTitle: z.string().min(5, { message: 'Title must be at least 5 characters long.' }).max(200),
  keyTopics: z.string().min(10, { message: 'Topics must be at least 10 characters long.' }).max(2000),
});
...
export async function generateCourseDescriptionAction(prevState: CourseDescriptionState, formData: FormData): Promise<CourseDescriptionState> {
...
const learningObjectivesSchema = z.object({
  courseTopic: z.string().min(10, { message: 'Topic must be at least 10 characters long.' }).max(2000),
});
...
export async function generateLearningObjectivesAction(prevState: LearningObjectivesState, formData: FormData): Promise<LearningObjectivesState> {
  ...
  try {
    ...
    console.error(error);
    return { objectives: null, error: 'Failed to generate objectives. Please try again.' };
  }
}
...
const emailSubjectLineSchema = z.object({
  emailContent: z.string().min(10, { message: 'Content must be at least 10 characters long.' }).max(2000),
});
...
export async function generateEmailSubjectLinesAction(prevState: EmailSubjectLineState, formData: FormData): Promise<EmailSubjectLineState> {
  ...
  try {
    ...
    console.error(error);
    return { subjectLines: null, error: 'Failed to generate subject lines. Please try again.' };
  }
}
...
export async function generateSocialMediaPostAction(prevState: SocialMediaPostState, formData: FormData): Promise<SocialMediaPostState> {
...
export async function generateFaqsAction(prevState: FaqState, formData: FormData): Promise<FaqState> {
...
export async function generateAnalogyAction(prevState: AnalogyState, formData: FormData): Promise<AnalogyState> {
