...
import { createComparisonCategory, updateComparisonCategory } from '@/app/actions/categories';
...
interface ComparisonCategoryFormProps {
  category?: ComparisonCategory | null;
}

export function ComparisonCategoryForm({ category }: ComparisonCategoryFormProps) {
  const router = useRouter();
  const isEditing = !!category;
  const formAction = isEditing ? updateComparisonCategory.bind(null, category.id) : createComparisonCategory;
