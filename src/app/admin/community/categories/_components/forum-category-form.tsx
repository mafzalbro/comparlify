...
import { createForumCategory, updateForumCategory } from '@/app/actions/categories';
...
export function ForumCategoryForm({ category }: ForumCategoryFormProps) {
  ...
  const formAction = isEditing ? updateForumCategory.bind(null, category.id) : createForumCategory;
